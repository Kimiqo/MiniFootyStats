...
import updateMatchHandler from './routes/admin/match/update.js';
import uploadMatchMediaHandler from './routes/admin/match/upload.js';
...
app.all('/api/admin/match/update', updateMatchHandler);
app.all('/api/admin/match/upload', uploadMatchMediaHandler);
